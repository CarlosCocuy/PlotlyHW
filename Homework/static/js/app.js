...
function buildCharts(sample) {
  ...
  d3.json(url).then(function(s){
    ...
    var p_ids = s.otu_ids.slice(0,10);
    var p_values = s.sample_values.slice(0,10);
    var p_labels = s.otu_labels.slice(0,10);
    var data =[{
      values: p_values,
      labels: p_ids,
      hovertest: p_labels,
